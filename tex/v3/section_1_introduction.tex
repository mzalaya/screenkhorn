...
A greedy version of Sinkhorn algorithm, called Greenkhorn algorithm, proposed in~\cite{altschulernips17}, allowing to select columns and rows to be updated that most violate the constraints.                   
...
In this paper, we give new algorithm to approximate the regularized OT distance between discrete measures. 
Our algorithmic analysis relies on an approximate of the dual of Sinkhorn divergence by adding new constraints feasibility. 
