...
\begin{figure*}[t]
	\centering
	%~\hfill~	\includegraphics[width=6.cm]{../../figure/da_toy_problem.pdf}~\hfill~\\
	~\hfill~\includegraphics[width=6.cm]{../../figure/wda_accur_toy.pdf}~\hfill~
	\includegraphics[width=6.cm]{../../figure/wda_accur_mnist.pdf}~\hfill~\\
...
\begin{figure*}[t]
	...
	%~\hfill~	\includegraphics[width=6.cm]{../../figure/da_toy_problem.pdf}~\hfill~\\
	~\hfill~\includegraphics[width=6.cm]{../../figure/da_toy_problem.pdf}~\hfill~
	\includegraphics[width=6.cm]{../../figure/da_accur_toy_regcl100.pdf}~\hfill~\\
	~\hfill~\includegraphics[width=6.cm]{../../figure/da_time_toy_regcl100.pdf}
	~\hfill~\includegraphics[width=6.cm]{../../figure/da_gain_toy_regcl100.pdf}~\hfill~\\
