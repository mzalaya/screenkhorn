...
The key idea of our approach is motivated by the so-called \emph{static screening test}~\cite{Ghaoui2010SafeFE} in supervised learning, that is a method able to quickly identify inactive features, i.e., features that have zero components in the solution vector. 
