...
In the sequel, we denote by $n_b \in\{1, \ldots, n\}$ and $m_b\in\{1, \ldots, m\}$ the number of points {that are going to be optimized in problem~\eqref{screen-sinkhorn}, \emph{i.e}, the points we can not guaranteed
