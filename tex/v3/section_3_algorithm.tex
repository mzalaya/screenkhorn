...
In Figure~\ref{fig:kappa_epsilon}, we plot these convergences, and hence the objective of approximate dual in problem \eqref{screen-sinkhorn} converges to the objective of dual of Sinkhorn divergence~\eqref{sinkhorn-dual}.
