...
largest component of the projected gradient is smaller than $10^{-6}$, when the
number of iterations of number of objective function evaluations reach $10^{5}$. For all
applications, we have set $\eta=1$.
...
\begin{figure*}[t]
	...
	\includegraphics[width=6.cm]{../../figure/da_gain_mnist_regcl10.pdf}
