...
\begin{figure*}[t]
	\begin{center}
		\includegraphics[width=6cm]{./figs/norm_M_Mu_marginals_toy_n1000} \hspace*{9pt}
		\includegraphics[width=6cm]{./figs/norm_M_Nu_marginals_toy_n1000} \\
		\includegraphics[width=6cm]{./figs/norm_M_time_toy_n1000} \hspace*{9pt}
		\includegraphics[width=6cm]{./figs/norm_M_div_toy_n1000}
	\end{center}
