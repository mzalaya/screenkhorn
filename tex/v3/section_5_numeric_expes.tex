...
\begin{figure*}[t]
	\begin{center}
		~\hfill~\includegraphics[width=5.5cm]{./figs/norm_M_Mu_marginals_toy_n1000}~\hfill~
		\includegraphics[width=5.5cm]{./figs/norm_M_Mu_marginals_toy_n1000}~\hfill~\\
		~\hfill~\includegraphics[width=5.5cm]{./figs/norm_M_time_toy_n1000}
		~\hfill~\includegraphics[width=5.5cm]{./figs/norm_M_div_toy_n1000}~\hfill~\\
	\end{center}
