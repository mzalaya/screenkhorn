...
\begin{figure*}[t]
	\begin{center}
		\includegraphics[width=0.33\textwidth]{./figs/norm_M_Mu_marginals_toy_n1000} ~\hfill~
		\includegraphics[width=0.33\textwidth]{./figs/norm_M_Nu_marginals_toy_n1000} ~\hfill \\
		\includegraphics[width=0.33\textwidth]{./figs/norm_M_time_toy_n1000} ~\hfill~
		\includegraphics[width=0.33\textwidth]{./figs/norm_M_div_toy_n1000}
	\end{center}
...
%	\includegraphics[width=4.cm]{../figs/wda_accur_mnist.pdf}
	\includegraphics[width=0.4\textwidth]{./figs/wda_gain_toy.pdf}
\includegraphics[width=0.4\textwidth]{./figs/wda_gain_mnist.pdf}
...
\begin{figure*}[t]
	...
	\includegraphics[width=0.42\textwidth]{./figs/da_gain_mnist_regcl1.pdf}
	\includegraphics[width=0.42\textwidth]{./figs/da_gain_mnist_regcl10.pdf}
