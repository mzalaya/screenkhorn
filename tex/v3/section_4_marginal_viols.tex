...
Our second theoretical result, Proposition~\ref{prop:objective-error}, is an upper bound of the difference between objective values of Screenkhorn and the dual of Sinkhorn divergence~\eqref{sinkhorn-dual}.
\begin{proposition}
