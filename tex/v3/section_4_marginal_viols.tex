...
%Using the facts that $\varepsilon \leq (mnK_{\min}^2)^{-1/4}$ and $\kappa \leq \sqrt{m/(nK_{\min})}$, 
% We can get a closed forms of~\eqref{maginal_mu} and~\eqref{maginal_nu} depending on $n,m,K_{\min}$, the budgets $n_b,m_b,$ and $c_{\mu\nu} = \underline{\mu}\wedge \underline{\nu}$ with $\underline{\mu} = \min_{i\in I_{\varepsilon,\kappa}}\mu_i, \underline{\nu} = \min_{j\in J_{\varepsilon,\kappa}}\nu_j$ as follows:
% \begin{align*}
...
% \bigg)\bigg]\Bigg)
% \end{align*}
% + \frac{m^{1/4}}{n^{3/4}m_bK_{\min}^{5/2}\underline{\nu}}
% and 
% \begin{align*}
