...
\section{Proof of Proposition~\ref{prop:objective-error}}
...
\begin{figure*}[htbp]
	...
	We remark that the strenght of the class-based regularization has influence on the performance of \emph{Screenkhorn} given a decimation factor. For small value on the left, \emph{Screenkhorn} slightly performs better than Sinkhorn, while for large value, some
